...
SECOND:
	...
	rjmp main			;still fixing this part - not sure where it should lead to
						;/how to call the second counter function
...
RESET:
	...
	cpi r23:r24, 0 ;if this doesn't work, put ADCH and ADCH into registers and adiw r24:r23,0 or something similar
	breq FIND_.include "m2560def.inc"
